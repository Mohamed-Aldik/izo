                ...
                <SubCard title="Primary Color">
                    <Grid container spacing={gridSpacing}>
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox bgcolor="primary.light" data={{ label: 'Blue-50', color: '#edeff2' }} title="primary.light" dark />
                        </Grid>
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                    ...
                    <Grid container spacing={gridSpacing}>
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox
                                ...
                                data={{ label: 'DeepPurple-50', color: '#edeff2' }}
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox
                                ...
                                data={{ label: 'DeepPurple-500', color: '#edeff2' }}
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox
                                ...
                                data={{ label: 'DeepPurple-600', color: '#edeff2' }}
                                title="secondary.dark"
                            />
                        </Grid>
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox bgcolor="secondary.800" data={{ label: 'DeepPurple-800', color: '#f1433b' }} title="secondary[800]" />
                        </Grid>
                    </Grid>
                </SubCard>
            </Grid>
